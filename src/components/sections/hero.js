...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">David Morcuende.</h2>;
  const three = <h3 className="big-heading">Technological Innovator.</h3>;
  const four = (
    <>
      <p>
        ...
        between the practical and the fantastical. If this blend of expertise and imagination is
        what you've been searching for, congratulations. <u>You're in the right pixels.</u>
      </p>
    </>
  );
  const five = (
